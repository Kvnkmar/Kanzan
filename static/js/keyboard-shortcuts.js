...
(function () {
    ...
    style.textContent = [
        ...
        '    outline-offset: -2px;',
        '    background-color: rgba(var(--crm-primary-rgb), 0.05) !important;',
        '}',
        '.shortcuts-list { margin: 0; }',
        '.shortcuts-list dt { float: left; clear: left; width: 100px; font-weight: normal; }',
        '.shortcuts-list dd { margin-left: 110px; margin-bottom: 4px; color: var(--crm-text-secondary); }',
        'kbd {',
        '    background: var(--crm-bg-elevated-2);',
